    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#020617]">
      ...
      {showVideo && (
        <video
          ...
          style={{ filter: 'brightness(0.72) contrast(1.06) saturate(0.92)' }}
      ...
      <div className="relative z-10 max-w-md w-full mx-auto px-4 py-12">
        ...
        >
          <div className="mb-5 text-center">
            ...
            <div className="text-3xl sm:text-4xl font-black tracking-tight text-white mb-3">So I built it.</div>
