...
function SideEffectsRenderer({ content, preview }) {
  ...
  if (preview) {
    ...
    return (<div className="flex flex-col items-center space-y-3 w-full"><div className="flex items-center justify-center gap-4 w-full"><div className="text-center min-w-[72px]"><div className="text-2xl font-bold text-red-400">{severe.length}</div><div className="text-[10px] text-slate-500 uppercase tracking-wider">Watch Closely</div></div><div className="text-center min-w-[72px]"><div className="text-2xl font-bold text-yellow-400">{mild.length}</div><div className="text-[10px] text-slate-500 uppercase tracking-wider">Be Aware</div></div>{positive.length > 0 && <div className="text-center min-w-[72px]"><div className="text-2xl font-bold text-emerald-400">{positive.length}</div><div className="text-[10px] text-slate-500 uppercase tracking-wider">Clean</div></div>}</div>{labels.length > 0 && <div className="flex flex-wrap justify-center gap-2">{labels.map(function(l, i) { return (<span key={i} className="px-3 py-1 rounded-full bg-slate-800/60 border border-white/5 text-[11px] text-slate-400">{l}</span>); })}</div>}<div className="text-center mt-2"><span className="text-[11px] text-slate-500 italic">Detailed severity analysis for Inner Circle members</span></div></div>);
  }
